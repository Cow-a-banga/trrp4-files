...
class RemoteFolderManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.actionF = channel.stream_unary(
...
def add_RemoteFolderManagerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'actionF': grpc.stream_unary_rpc_method_handler(
                    servicer.actionF,
...
class RemoteFolderManager(object):
    ...
    def actionF(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/example.RemoteFolderManager/actionF',
